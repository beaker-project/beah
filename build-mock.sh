...
tito build --test --rpm -o "$(pwd)/tito-output" --dist .el7 --builder mock --builder-arg mock=eso-rhel-7-x86_64
...
scp tito-output/beah-*.el7.noarch.rpm $DEST:/var/www/beaker/harness/RedHatEnterpriseLinux7/
...
scp tito-output/beah-*.fc19.noarch.rpm $DEST:/var/www/beaker/harness/Fedorarawhide/
